...
// array to manage transcriptions
let transcribedArray = Array();
...
let handleEventStreamMessage = function (messageJson) {
    ...
    transcribedArray[transcribedArray.length] = transcription;
    console.log(transcribedArray);
}
...
async function getBotResponse(uInput) {
    let userInput = uInput;
    const response = await Interactions.send("KellsPOC_dev", userInput);
